...
# Model for basic user with a password hash field instead of plain text.
...
# Model for basic CRUD item with a One-To-Many relationship (One user, many bookmarks)
# and a many to many relationship on a separate junction table that's not a model.
